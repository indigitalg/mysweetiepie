        ...
        <div class="ps-product--detail" style="margin-bottom:0px;">
          ...
          <div class="row">
            ...
            <div class="col-sm-6 col-sm-offset-3">
                ...
                <form action="/holidayseason/add-cart" method="POST" />
                @csrf
                ...
                <div id="select-pickup">
                    ...
                    <div id="date-select">
                            <label><input type="radio" name="pickup_date" value="2021-12-15" /> &nbsp;  15<sup>th</sup>  &nbsp; <span>December</span></label>
                            <label><input type="radio" name="pickup_date" value="2021-12-16" checked="checked" /> &nbsp; 16<sup>th</sup> &nbsp; <span>December</span></label>
                            <label><input type="radio" name="pickup_date" value="2021-12-17" checked="checked" /> &nbsp; 17<sup>th</sup> &nbsp; <span>December</span></label>
                    </div>
                </div>
