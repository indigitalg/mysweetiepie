          ...
          <div class="col-sm-12">
              ...
              <div id="delivery-action">
                  ...
                  <div class="row">
                      ...
                      <div class="col-sm-6" id="localpickup">

                          <div id="local-pickup-option" class="delivery-option">

                              <h4>Local Pickup Locations</h4>

                              <form action="/holidayseason/shop/options" method="POST" id="pickup-form">
                      ...
                      <div class="col-sm-6" id="localdelivery">
                          ...
                          <div id="reliable-delivery-option" class="delivery-option">
                              ...
                              <div id="delivery-form-wrapper">
                                  ...
                                  <form action="/holidayseason/shop/options" method="POST" id="delivery-form" >
