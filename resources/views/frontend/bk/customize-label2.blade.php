          ...
          <div id="label-image">
            ...
            <div id="dynamic-edit" style="display:none;">
              ...
              <div class="dynamic-top">
                ...
                <div class="editor-tool">
                  <input type="color" class="edit-box" id="editor-color" name="color" value="" />
...
$(document).ready(function(){
  ...
  $("body").delegate(".text-line","click",function(){
      ...
      $("#dynamic-edit").css("top",Math.floor(position.top+50+height)+"px");
      $("#dynamic-edit").css("left",Math.floor(position.left)+"px");
  ...
  function addTextLine(textid = '') {
      ...
      var pos = $("#customizable-area").find('div:last-child').position();
      
      if($("#customizable-area").children().length < 4) {
        $("#customizable-area").append('<div class="text-line draggable" id="show_'+textid+'">'+text+'</div>');
        $("#show_"+textid ).draggable();
        $("#show_"+textid).css("color",'{{$label->color ?? "#000000"}}');
        
        if(pos != undefined) {
           $("#show_"+textid).css("top",(pos.top + 30) + 'px');
           $("#show_"+textid).css("left",(pos.left) + 'px');
        }
        else
        {
           $("#show_"+textid).css("top",'30px');
           $("#show_"+textid).css("left",'80px');
        }
      }
      
      if($("#customizable-area").children().length > 3) {
        $("#add-field").css("display","none");  
      }
      else
      {
