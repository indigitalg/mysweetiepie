      ...
      <div class="ps-container">
          ...
          @if(session()->has('error'))
                <div class="alert alert-danger" style="font-size:110%;"><strong>Unfortunately, we were unable to process your credit card, 
                    ...
                    <u><a href="/support?err=payment_failed" style="font-weight:bold;">Contact Us here</a></u> if you are facing issues</strong></div>
          @endif
          ...
          <div class="row">
            ...
            <div class="col-lg-8 col-md-8 col-sm-12 col-xs-12 " id="checkoutInfo">
                        ...
                        <div class="form-group form-group--inline">
                          ...
                          <div class="form-group__content">
                            ...
                            <label>
                                ...
                                <input class="" type="checkbox" name="billing_same" id="billing_same" @if(!empty($billing_name) && $billing_same == 'Yes') checked="checked" @endif value="Yes" > 
                ...
                @endif
                  ...
                  <div class="ps-checkout__billing"  id="billing_address">
    ...
    <script>
        ...
        $(document).ready(function(){
            ...
            $('#billing_same').click(function(e) {
                ...
                //$('#billing_same').val(this.checked ? 1 : 0);        
