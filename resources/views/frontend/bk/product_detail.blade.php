...
<main class="ps-main">
    ...
    <div class="ps-product--detail">
      ...
      <div class="row">
        ...
        <div class="col-lg-7 col-md-6 col-sm-12 col-xs-12">
          ...
          <div class="ps-product__preview productgallery_thumbnail">
  ...
  <div class="col-lg-5 col-md-6 col-sm-12 col-xs-12 ">
      ...
      <div class="ps-product__info">
        ...
        @if($product->status ==0)<h3><span style="color: red;font-size: 26px;"> (Sold Out)</span></h3>@endif
   ...
   <form class="ps-form--shopping" action="" method="post" id="cartform">
       ...
       <div class="row">
                        ...
                        @if(session('shippingType') != 'pickup')
                                    ...
                                    <div id="calendar-container" style="display:none;">
                                        ...
                                        <div id="calendar">
                                            ...
                                            <div class="month">
                                                ...
                                                {!!getPickupCalendar(date('n'),date('Y'),session('cityIdSet'), $product->sku == 'BCCS6' ? ['2022-02-11','2022-02-12','2022-02-13','2022-02-14','2022-02-15','2022-02-16']:[])!!}
                                            ...
                                            <div id="more-dates1" class="more-dates">
                                                ...
                                                <div class="month">
                                                    ...
                                                    {!!getPickupCalendar(date('n',strtotime('first day of +1 month')),date('Y',strtotime('first day of +1 month')),session('cityIdSet'),$product->sku == 'BCCS6' ? ['2022-02-11','2022-02-12','2022-02-13','2022-02-14','2022-02-15','2022-02-16']:[])!!}
                                        ...
                                        <div id="calendar">
                                            ...
                                            <div class="month">
                                                ...
                                                {!!getCalendar(date('n'),date('Y'),$product->shippings[0]->id ?? 0,NULL,$product->sku == 'BCCS6' ? ['2022-02-11','2022-02-12','2022-02-13','2022-02-14','2022-02-15','2022-02-16']:[])!!}
                                            ...
                                            <div class="more-dates" id="more-dates2">
                                                ...
                                                <div class="month">
                                                    ...
                                                    {!!getCalendar(date('n',strtotime('first day of +1 month')),date('Y',strtotime('first day of +1 month')),$product->shippings[0]->id ?? 0,$product->sku == 'BCCS6' ? ['2022-02-11','2022-02-12','2022-02-13','2022-02-14','2022-02-15','2022-02-16']:[])!!}
                            ...
                            <div class="col-sm-12">
                                ...
                                <ul id="date-select">
                                    ...
                                    <?php $days = getNearestPickupDates(session('cityIdSet'),5,$product->sku == 'BCCS6' ? ['2022-02-11','2022-02-12','2022-02-13','2022-02-14','2022-02-15','2022-02-16']:[]); ?>

                                    @foreach($days as $day)

                                    <li class="d-date">
                                        
                                        @if(date('Y-m-d',strtotime($day['day'])) == '2021-12-24')
                                        
                                          <a href="#" class="boxdate" onclick="changePickupDate(event, '{{date('Y-m-d',strtotime($day['day']))}}', '{{date('D d M',strtotime($day['day']))}}', '{{$day['open']}}', '2021/12/24 15:30:00')" 
                                ...
                                <?php $days = getNearestDates($product->shippings[0]->id,5,$product->sku == 'BCCS6' ? ['2022-02-11','2022-02-12','2022-02-13','2022-02-14','2022-02-15','2022-02-16']:[]); ?>
                    ...
                    <!--<div class="col-sm-12">-->
                        ...
                        <!--    <div style="margin-top:10px;text-align:right;">-->
                            ...
                            <div class="col-sm-6 form-group" style="margin-bottom: unset;">
                            ...
                            <select class="form-control major-qty" name="qty" id="qty" style="border-radius:40px">
                              ...
                              <option value="30">30 With Customized Label</option>
                              <option value="36">36 With Customized Label</option>
                              <option value="42">42 With Customized Label</option>
                              <option value="48">48 With Customized Label</option>
                              <option value="54">54 With Customized Label</option>
                              <option value="60">60 With Customized Label</option>
                          </select>  
                          ...
                          <div class="form-group--number">
                              ...
                              <input class="form-control major-qty" type="text" onkeyup="if (/\D/g.test(this.value)) this.value = this.value.replace(/\D/g,'')" value="1" name="qty" id="qty" @if(time() < strtotime('2022-10-11')) max="3" @endif readonly>
                    ...
                    @if(in_array('crazy-good-cake',$categories))
                    <div class="col-sm-8 form-group" style="margin-bottom: unset;">
                        <p>&nbsp;</p>
                        <p style="margin-top:35px;">Label customization is available on orders above 30 pieces</p>
                    </div>
                ...
                @if(in_array('crazy-good-cake',$categories))
                            ...
                            <div class="ps-product__sharing col-sm-12" style="text-align: center;">
                                ...
                                @else
                                <div style="color: red;text-align: left;font-size: 40px;">Sold Out</div>
                                <!--<button class="ps-btn ps-btn--yellow submit-order" style="float: none;width:100%;color:red" type="button" id="outofstock">Out Of Stock</button>-->
                                @endif
                            ...
                            @if(strpos(strtolower($product->name),'frozen'))
                                <p style="text-align:center;text-transform:uppercase;clear:both;float:none; display:block;padding-top: 15px;"><a href="/downloads/baking_instructions.pdf" target="_blank" id="bakinginfo-button">Baking Instructions</p>
                            @endif
    ...
    <div class="ps-product__content">
        ...
        <ul class="tab-list" role="tablist">
          ...
          @if(isset($product->nutrition) && $product->nutrition != '' )
            <li><a href="#tab_02" aria-controls="tab_02" role="tab" data-toggle="tab">Nutrition info</a></li>
          @endif
          <li><a href="#tab_03" aria-controls="tab_03" role="tab" data-toggle="tab">Delivery Policy

          </a></li>

          <li><a href="#tab_04" aria-controls="tab_04" role="tab" data-toggle="tab">Substitution Policy
  ...
  <div class="tab-content">
   ...
   @if(isset($product->nutrition) && $product->nutrition != '' )
    <div class="tab-pane" role="tabpanel" id="tab_02">
      <div class="nutrient_info">
          <img src="/images/nutrition_info/{{$product->nutrition}}" alt="Nutrient Info"/>
      </div>
      </div>
    @endif
...
<div class="modal fade" tabindex="-1" role="dialog" id="cart-confirm" style="margin-left:auto;margin-right:auto;">
  <div class="modal-dialog" role="document">
    ...
    <div class="modal-body">
        <h3 style="padding: 50px 15px; text-align:center;">Thank you<br/> {!!$product->name!!} has been added to the cart</h3>
    </div>
    <div class="modal-footer text-center" style="text-align: center !important;">
        ...
        <a href="{{url('/shop/cart')}}" style="margin-bottom:15px;display:inline-block;"><button type="button" class="ps-btn ps-btn--yellow submit-order">Proceed to Checkout</button></a>
    </div>
</div><!-- /.modal-content -->
</div><!-- /.modal-dialog -->
</div><!-- /.modal -->
