                          ...
                          <div class="tab-content label-contents">
                            ...
                            <div id="home" class="tab-pane fade in active">
                                ...
                                <div class="row label-show">
                                    ...
                                    <div class="col-sm-3 label-image-container" onclick="clickLabel({{$label->id}},this)">
                                ...
                                <div class="row contents hidden">
                                    ...
                                    <div class="col-sm-8">
                                        ...
                                        <div class="form-group image-display">
                                            ...
                                            <h1 class="name-header">Jake's</h1>

                                            <h1 class="event-number">5<sup>th</sup></h1>

                                            <h1 class="event-name">Birthday</h1>

                                            <h4 class="event-date">21 September 2020</h4>
                                        ...
                                        <div class="tab-content">
                                          ...
                                          <div id="line1" class="tab-pane fade in active">
                                            ...
                                            <div class="form-group">
                                                ...
                                                <select class="form-control" name="label_font1">
                                            ...
                                            <div class="form-group col-md-6">
                                                ...
                                                <input type="color" value="#000000" class="form-control" name="label_font_color1" />
                                            ...
                                            <div class="form-group col-md-6">
                                                ...
                                                <select class="form-control label-font-size" name="label_font_size1">
                                          ...
                                          <div id="line2" class="tab-pane fade">
                                            ...
                                            <div class="form-group">
                                                ...
                                                <select class="form-control" name="label_font2">
                                            ...
                                            <div class="form-group col-md-6">
                                                ...
                                                <input type="color" value="#000000" class="form-control" name="label_font_color2" />
                                            ...
                                            <div class="form-group col-md-6">
                                                ...
                                                <select class="form-control label-font-size2" name="label_font_size2">
                                          ...
                                          <div id="line3" class="tab-pane fade">
                                            ...
                                            <div class="form-group">
                                                ...
                                                <select class="form-control" name="label_font3">
                                            ...
                                            <div class="form-group col-md-6">
                                                ...
                                                <input type="color" value="#000000" class="form-control" name="label_font_color3" />
                                            ...
                                            <div class="form-group col-md-6">
                                                ...
                                                <select class="form-control label-font-size3" name="label_font_size3">
                                          ...
                                          <div id="line4" class="tab-pane fade">
                                            ...
                                            <div class="form-group">
                                                ...
                                                <select class="form-control" name="label_font4">
                                            ...
                                            <div class="form-group col-md-6">
                                                ...
                                                <input type="color" value="#000000" class="form-control" name="label_font_color4" />
                                            ...
                                            <div class="form-group col-md-6">
                                                ...
                                                <select class="form-control label-font-size4" name="label_font_size4">
      ...
      <div class="modal-dialog" role="document">
        <div class="modal-content">
          ...
          <div class="modal-body" style="text-align:center;padding: 35px;">
            ...
            <img src="/img/jar.jpg" style="width:250px;height:250px; margin:0px auto;" />

            <h1 style="font-size: 200%;margin:25px 0px;">Customize Label</h1>
            <p style="margin:25px 0px;">Click yes to customize your cake jar label?</p>
